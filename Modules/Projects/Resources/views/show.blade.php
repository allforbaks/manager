    ...
    <div class="q-about-us _show-720">
        <div class="q-inner">
            <div class="q-filters-with-buttons">
                <a href="projects/create" class="q-button _red js-show-q-create-message-popup">Новая задача</a>
                ...
                <div class="g-task">
                    <a class="open-g-task js-show-q-view-task-admin-popup" href="#">
                        <div class="g-task-header"><div class="g-task-header-name">Мне поручил Антон Иванович Иванов:</div>
                            Рассчитать бюджет на покупку компанией вертолётика на радиоуправлении<div class="g-task-footer-urgency"></div></div>
                    </a>
